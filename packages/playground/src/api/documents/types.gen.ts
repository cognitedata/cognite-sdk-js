...
export interface Document {
   ...
   * @example {"0":{"externalId":"play"},"1":{"externalId":"tragedy"}}
   */
  labels: LabelList;
...
export type DocumentGeoLocationFilter =
  | ValueMissing
  | { relation: Relation; shape: DocumentGeoLocation };
...
/**
 * @example {"author":{"0":"TERMS"},"sourceFile":{"content":{"0":"TERMS","1":"TYPES"},"directory":{"0":"DIRECTORIES"},"name":{"0":"TERMS"}},"title":{"0":"TERMS"},"type":{"0":"TERMS","1":"TYPES"}}
 */
...
export interface DocumentsPipelineSensitivityMatcher {
   ...
   * @example {"DIRECTORIES":{"0":"secret"},"TERMS":{"0":"secret","1":"confidential","2":"sensitive"},"TYPES":{"0":"contracts","1":"emails"}}
   */
