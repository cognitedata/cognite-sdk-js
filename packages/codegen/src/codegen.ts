...
export class CodeGen {
   ...
   */
  #saveGeneratedTypes = async (result: TypeGeneratorResult): Promise<void> => {
...
// Instead update the code generation logic or the OpenAPI document.\n\n`;
  ...
  #transformQueryParametersToSchemas = (
  ...
  #astPostProcessing = (code: string): string => {
