...
//import { LoginAPI } from 'core/src/api/login/loginApi';
//import { LogoutApi } from 'core/src/api/logout/logoutApi';
import {
  X_CDF_APP_HEADER,
  X_CDF_SDK_HEADER,
  API_KEY_HEADER,
} from 'core/src/constants';
import { HttpHeaders, HttpRequestOptions, HttpResponse } from '..';
import {
  CDFHttpClient,
...
import { OnAuthenticate, OnTokens } from 'core/src/login';
import { getBaseUrl, isUsingSSL, projectUrl } from 'core/src/utils';
import { version } from 'os';

export interface ClientOptions {
  /** App identifier (ex: 'FileExtractor') C*/
  appId: string;
  baseUrl?: string;
}
