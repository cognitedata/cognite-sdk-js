 ...
 */
export interface DocumentCellElement {
    lines: DocumentLineElement[];
}
/**
 * A character. Contains a reference to the relevant page, and a bounding box.
 */
export interface DocumentCharacterElement {
    bottom: number;
    left: number;
    /** The page number where the character can be found. Pages start at 1. */
    page: number;
    right: number;
    /**
     * The text representing the character. This is usually one character long, but may be more
 ...
 */
export type DocumentElement = DocumentTitleElement | DocumentParagraphElement | DocumentListElement | DocumentTableOfContentsElement | DocumentTableElement;
export interface DocumentElementsResponse {
 ...
 */
export interface DocumentLineElement {
    words: DocumentWordElement[];
}
/**
 ...
 * A JSON based filtering language. See detailed documentation above.
 */
export type DocumentSemanticFilter = DocumentSemanticFilterBool | DocumentSemanticFilterLeaf;
/**
* A query that matches items matching boolean combinations of other queries.
It is built using one or more boolean clauses, which can be of types: `and`, `or` or `not`
*/
export type DocumentSemanticFilterBool = {
    and: DocumentSemanticFilter[];
};
/**
 * Leaf filter
 */
export type DocumentSemanticFilterLeaf = DocumentFilterEquals | DocumentFilterIn | DocumentFilterSemanticSearch;
/**
 * Semantic insight about a search result
 */
export interface DocumentSemanticMatch {
    locations?: {
        pageNumber?: number;
        left?: number;
        right?: number;
 ...
 */
export interface DocumentSemanticSearchFilter {
    /**
     * A JSON based filtering language. See detailed documentation above.
     *
     */
    filter: DocumentSemanticFilter;
}
/**
 * Each item contains the semantic match and the relevant document it belongs to.
 */
export interface DocumentSemanticSearchItem {
    /** A document */
    item: Document;
    /** Semantic insight about a search result */
    match: DocumentSemanticMatch;
}
export interface DocumentSemanticSearchLimit {
    /**
...
export type DocumentSemanticSearchRequest = DocumentSemanticSearchFilter & DocumentSemanticSearchLimit;
export interface DocumentSemanticSearchResponse {
    items: DocumentSemanticSearchItem[];
}
...
export interface DocumentStatusItem {
    ...
    semanticSearch: {
        status: "waiting" | "ignored" | "error" | "indexed" | "progress";
    };
...
cells.
*/
export interface DocumentTableElement {
    ...
    rows: DocumentCellElement[][];
    type: "table";
}
/**
 * A table of contents.
 */
export interface DocumentTableOfContentsElement {
    lines: DocumentLineElement[];
    type: "toc";
}
/**
 ...
 */
export interface DocumentTitleElement {
    /**
...
/**
 * A single word containing a list of characters
 */
export interface DocumentWordElement {
    characters: DocumentCharacterElement[];
}
/**
