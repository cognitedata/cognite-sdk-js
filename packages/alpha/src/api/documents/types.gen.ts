...
export type DocumentListRequest = DocumentListFilter &
  ...
  DocumentListLimit &
  DocumentCursor;
export type DocumentListResponse = CursorAndAsyncIterator<Document>;
/**
 ...
 */
export type DocumentsAggregateAllUniquePropertiesResponse =
  CursorAndAsyncIterator<DocumentsAggregateAllUniquePropertiesItem>;
 ...
 * @example {"items":[{"count":4,"values":["hello"]},{"count":33,"values":["world"]}]}
 */
export type DocumentsAggregateAllUniqueValuesResponse =
 ...
 * A JSON based filtering language. See detailed documentation above.
 */
export type DocumentSemanticFilter =
 ...
 * Leaf filter
 */
export type DocumentSemanticFilterLeaf =
  | DocumentFilterEquals
  | DocumentFilterIn
...
export type DocumentSemanticSearchRequest = DocumentSemanticSearchFilter &
