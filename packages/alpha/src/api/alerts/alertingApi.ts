...
import { Alert, AlertCreate, AlertFilter, ChannelChange, ChannelCreate, ChannelFilter, SubscriberCreate, SubscriptionCreate, SubscriptionDelete } from '../../types';
...
export class AlertingAPI extends BaseResourceAPI<Alert> {
  ...
  constructor(...args: [string, CDFHttpClient, MetadataMap]) {
    ...
    this.alertsApi = new AlertsAPI(`${resourcePath}/alerts`, client, metadataMap);
    this.channelsApi = new ChannelsAPI(`${resourcePath}/channels`, client, metadataMap);
    this.subscribersApi = new SubscribersAPI(`${resourcePath}/subscribers`, client, metadataMap);
    this.subscriptionsApi = new SubscriptionsAPI(`${resourcePath}/subscriptions`, client, metadataMap);
  }
