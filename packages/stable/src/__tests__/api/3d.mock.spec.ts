...
import { transformDateInRequest } from '@haved/cogsdk-core';
...
describe('3D mocked', () => {
  ...
  describe('revisions', () => {
    ...
    test('delete', async () => {
      ...
      nock(mockBaseUrl)
        .post(regExp, { items: deleteRequest })
        .reply(200, {});
