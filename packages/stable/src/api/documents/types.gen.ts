...
export interface DocumentFilterContainsAll {
   ...
   * @example {"property":{"0":"assetIds"},"values":{"0":51276,"1":94287}}
   */
  containsAll: {
...
export interface DocumentFilterEquals {
   ...
   * @example {"property":{"0":"type"},"value":"PDF"}
   */
...
export interface DocumentFilterIn {
   ...
   * @example {"property":{"0":"author"},"values":{"0":"Etiam Eget","1":"Praesent Vestibulum"}}
   */
...
export interface DocumentFilterPrefix {
   ...
   * @example {"property":{"0":"name"},"value":"Report"}
   */
...
export interface DocumentFilterRange {
   ...
   * `lt`: Less than.
   *
   * @example {"gte":1609459200000,"lt":1640995200000,"property":{"0":"createdTime"}}
   */
  range: {
...
/**
 * GeoJSON Geometry.
 * @example {"coordinates":{"0":10.74609,"1":59.91273},"type":"Point"}
 */
export interface DocumentGeoJsonGeometry {
  /**
   * Coordinates of the geometry.
   * @example {"0":10.74609,"1":59.91273}
   */
  coordinates: any[];
 ...
 * @example {"content":{"0":"Nunc <em>vulputate erat</em> ipsum, at aliquet ligula vestibulum at","1":"<em>Quisque</em> lectus ex, fringilla aliquet <em>eleifend</em> nec, laoreet a velit.\n\nPhasellus <em>faucibus</em> risus arcu"},"name":{"0":"amet elit <em>non diam</em> aliquam suscipit"}}
 */
...
export interface DocumentSearch {
  search?: { highlight: boolean; query: string };
}
...
export interface DocumentSearchAggregates {
  /** @example {"0":{"aggregate":"count","groupBy":{"0":{"property":{"0":"type"}}},"name":"countOfTypes"}} */
  aggregates?: DocumentSearchCountAggregate[];
}

/**
 * @example {"aggregate":"count","groupBy":{"0":{"property":{"0":"type"}}},"name":"countOfTypes"}
 */
 ...
 * @example {"items":{"0":{"count":4,"values":{"0":"hello"}},"1":{"count":33,"values":{"0":"world"}}}}
 */
...
export type DocumentsAggregateCountRequest = {
  search?: { query: string };
} & DocumentSearchFilter & { aggregate?: 'count' };

/**
 * Response for count aggregate.
 * @example {"items":{"0":{"count":10}}}
 */
