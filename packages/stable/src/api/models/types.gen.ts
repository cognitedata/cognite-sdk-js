// Code generation is disabled for this module (see codegen.skip.json) —
// this file is hand-maintained despite the .gen.ts name.

import type { CursorAndAsyncIterator } from '@cognite/sdk-core';
export interface AllVersionsQueryParameter {
  allVersions?: boolean;
}
export type ByExternalIdsDataModelsRequest =
