...
In Cognite Data Fusion, a [sequence](../../../concepts/resource_types/sequences.md) is a generic **resource type** for indexing a series of **rows** by **row number**. Each **row** contains one or more **columns** with either string or numeric data. Examples of sequences are performance curves and various types of logs.
...
**In this article:**
  ...
  - [Retrieve sequences by id](#retrieve-a-sequence-by-id)
